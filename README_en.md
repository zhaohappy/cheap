...
const resource = await compile(
  ...
  },
  {
    ...
    //The initialization function that needs to be called after the wasm module is run, it is generally generated by the compilation tool. emscripten is the following two
